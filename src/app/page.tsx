...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-slate-900">
      ...
      <HeroTransitionCover>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative w-full flex-1 flex flex-col justify-between py-4 sm:py-6 space-y-6 sm:space-y-8">
          
          {/* CONTEÚDO CENTRALIZADO (Pill Animada, Título, Subtítulo e Busca) */}
          <div className="text-center max-w-5xl lg:max-w-6xl mx-auto space-y-4 sm:space-y-6 my-auto w-full pt-2">
            
            {/* BOTÃO ANIMADO DE CADASTRO DO VETERINÁRIO/CLÍNICA */}
            <div className="flex justify-center">
              <Link
                href="/cadastro"
                className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-white hover:bg-emerald-50 text-[#147A44] border border-emerald-300 font-extrabold text-xs sm:text-sm shadow-xs hover:shadow-md transition-all hover:scale-[1.02] group relative overflow-hidden"
              >
                <span className="relative flex h-2.5 w-2.5 shrink-0">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#147A44]"></span>
                </span>
                <Stethoscope className="w-4 h-4 text-[#147A44] group-hover:rotate-12 transition-transform shrink-0" />
            ...
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[4.5rem] font-black text-slate-900 tracking-tight leading-[1.08] sm:leading-[1.1] max-w-5xl mx-auto">
            ...
            <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-slate-600 font-medium leading-relaxed max-w-4xl mx-auto">
          ...
          <div className="max-w-7xl mx-auto w-full pt-4 pb-2">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-5">
              
              {/* Card 1: Vets Cadastrados */}
              <div className="bg-white/95 backdrop-blur-md p-4 sm:p-5 rounded-2xl sm:rounded-3xl border border-slate-200/90 shadow-xs hover:shadow-md hover:border-emerald-300 transition-all group flex flex-col justify-between space-y-2.5">
                <div className="flex items-center justify-between">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-emerald-50 text-[#147A44] flex items-center justify-center font-bold">
                    <Stethoscope className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 text-[10px] sm:text-[11px] font-bold border border-emerald-200/60">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                    Ativos hoje
                  </span>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 tracking-tight group-hover:text-[#147A44] transition-colors">
                    +3.500
                  </div>
                  <div className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider mt-1">
              ...
              <div className="bg-white/95 backdrop-blur-md p-4 sm:p-5 rounded-2xl sm:rounded-3xl border border-slate-200/90 shadow-xs hover:shadow-md hover:border-emerald-300 transition-all group flex flex-col justify-between space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="px-2.5 py-0.5 rounded-full bg-slate-100 text-slate-600 text-[10px] sm:text-[11px] font-bold">
                    CFMV / Siscad
                  </span>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-black text-[#147A44] tracking-tight">
                    100%
                  </div>
                  <div className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider mt-1">
              ...
              <div className="bg-white/95 backdrop-blur-md p-4 sm:p-5 rounded-2xl sm:rounded-3xl border border-slate-200/90 shadow-xs hover:shadow-md hover:border-blue-300 transition-all group flex flex-col justify-between space-y-2.5">
                <div className="flex items-center justify-between">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center font-bold">
                    <Users className="w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <span className="px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-700 text-[10px] sm:text-[11px] font-bold">
                    Em todo o Brasil
                  </span>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 tracking-tight group-hover:text-blue-600 transition-colors">
                    +120 mil
                  </div>
                  <div className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider mt-1">
                    Pets Atendidos
              ...
              {/* Card 4: Avaliação */}
              <div className="bg-white/95 backdrop-blur-md p-4 sm:p-5 rounded-2xl sm:rounded-3xl border border-slate-200/90 shadow-xs hover:shadow-md hover:border-amber-300 transition-all group flex flex-col justify-between space-y-2.5">
                <div className="flex items-center justify-between">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-amber-50 text-amber-500 flex items-center justify-center font-bold">
                    <Star className="w-4 h-4 sm:w-5 sm:h-5 fill-amber-400 text-amber-400" />
                  </div>
                  <span className="px-2.5 py-0.5 rounded-full bg-amber-50 text-amber-700 text-[10px] sm:text-[11px] font-bold">
                    5 Estrelas
                  </span>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 tracking-tight flex items-center gap-1 group-hover:text-amber-500 transition-colors">
                    4.9 <span className="text-amber-400 text-xl sm:text-2xl">★</span>
                  </div>
                  <div className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider mt-1">
