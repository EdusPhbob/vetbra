      ...
      >
        ...
        <div className="space-y-1.5 px-3 py-1">
          ...
          <select 
            ...
            className="w-full bg-transparent text-sm sm:text-base font-semibold text-slate-800 focus:outline-hidden cursor-pointer"
          >
        ...
        {/* Campo Especialidade */}
        <div className="space-y-1.5 px-3 py-1 sm:border-l border-slate-200">
          <label className="text-[11px] font-extrabold uppercase tracking-wider text-slate-400 block">
            O que precisa?
          </label>
          <select 
        ...
        <div className="space-y-1.5 px-3 py-1 lg:border-l border-slate-200 relative">
          ...
          <div className="flex items-center gap-1.5">
            <input
              ...
              className="w-full bg-transparent text-sm sm:text-base font-semibold text-slate-800 focus:outline-hidden placeholder:text-slate-400/90 placeholder:italic"
            />
            {cepLoading && (
