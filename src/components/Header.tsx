        ...
        <div className="flex items-center justify-between py-3.5 sm:py-4">
          ...
          <Link href="/" className="flex items-center gap-3.5 group">
            <img
              ...
              className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl object-cover border border-slate-200 shadow-md group-hover:scale-105 transition-transform shrink-0"
            />
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                <span className="text-3xl sm:text-4xl font-black tracking-tight text-slate-900 leading-none">Vet<span className="text-[#147A44]">Bra</span></span>
                <span className="hidden lg:inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-50 text-[#147A44] border border-emerald-200">
                  <ShieldCheck className="w-3 h-3 mr-1" /> Oficial
                </span>
              </div>
              <span className="text-[11px] sm:text-xs font-bold text-slate-500 tracking-wider uppercase mt-1">
